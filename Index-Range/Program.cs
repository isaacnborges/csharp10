...
var tecnologias = new string[] { ".NET 6", "C#", "ASP.NET Core", "Azure", "Blazor", "Visual Studio 2022" };
...
static void ImprimirElementos(IEnumerable<string> selecaoTecnologias, string mensagem)
{
